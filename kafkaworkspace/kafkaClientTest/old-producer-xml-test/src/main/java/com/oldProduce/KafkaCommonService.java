...
public class KafkaCommonService {
    ...
    public void sendMessage(){
        System.out.println("开始生产信息..send(String topic, K k, V v)....");
        producer.send("kafka20601","Number01","this message A");
        System.out.println("生产信息结束..send(String topic, K k, V v)....");
    }
