...
<div
   ...
   <form class="form-inline" method="post" enctype="MULTIPART/FORM-DAT" action="UploadServlet">
...
<div
 style="margin:0px auto;width:1200px;height:500px backgroud:#fff">
 <table
    class="table table-hover" style="width:1000px;margin-left:100px;">
    <tr>
    <td>文件名</td>
    <td>属性</td>
    <td>大小[kB]</td>
