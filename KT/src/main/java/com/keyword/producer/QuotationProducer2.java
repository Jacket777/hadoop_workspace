 ...
 * 单线程生产数据---不回调
 */
public class QuotationProducer2 {
	private static final Logger LOG = Logger.getLogger(QuotationProducer2.class);
	// 设置实例生产消息的总数
	private static final int MSG_SIZE = 100;
	// 主题名称
	private static final String TOPIC = "stock-quotation";
	// kafka集群
	private static final String BROKER_LIST = "192.168.150.130:9092,192.168.150.131:9092,192.168.150.132:9092";
