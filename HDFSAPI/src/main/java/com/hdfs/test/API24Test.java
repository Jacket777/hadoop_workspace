 ...
 */
public class API24Test {
    //编号NO.1
    //测试API:mkdirs(Path path)  path为文件夹全路径
    public static void testMKdirs(String path) {
        String APIName = "mkdirs(Path path)";
        System.out.println("测试创建文件API "+APIName+"开始.........");
        System.out.println("测试准备 1:获取DFS对象");
        DistributedFileSystem dfs = Tool.getDistributedFileSystem();
        if(dfs == null){
            System.out.println("获取DFS对象失败，请检查");
            return;
        }
        System.out.println("测试准备 2:检查目录设置是否正确");
        if (Tool.checkIsPath(path)) {
            System.out.println("该目录已经存在，请输入其他目录");
            return;
        }else{
            System.out.println("该目录不存在，API将新文件夹");
        }
        ...
        System.out.println("测试创建文件API "+APIName+"结束.........");
    }
    ...
    public static void testMKdirsWithP(String path) {
        ...
        try {
            ...
            e.printStackTrace();
            System.out.println("创建文件夹出现异常，请检查");
        } finally {
            System.out.println("创建文件夹结束");
        }
    ...
    public static void testMKdirWithP(String path) {
        ...
        try {
            ...
            e.printStackTrace();
            System.out.println("创建文件夹时 出现异常");
        } finally {
            System.out.println("创建文件夹结束");
        }
        //判断文件夹是否创建成功
    ...
    public static void testCreateFile(String path) {
        ...
        System.out.println("测试案例 1：文件不存在，创建新文件");
        ...
        //检查创建文件结果
        System.out.println("检查测试案例执行结果");
        String realContent= Tool.getContent(path);
        System.out.println("文件内容为 : "+realContent);
        if(Tool.checkFile(path)&&(realContent!=null)&&(realContent.equals(content))){
            System.out.println("测试用例 1 执行成功，测试通过");
        }else{
            System.out.println("测试用例 1 执行失败，测试不通过");
        }
        System.out.println("===================>>>>>>>>>>>>>==============================");
        System.out.println("测试案例 2：文件存在，重写新文件");
        String content2 = "World";
        if (!Tool.checkFile(path)) {
            System.out.println("该文件不存在，不满足测试条件，请检查测试代码");
            return;
        }
        ...
        System.out.println("文件内容为 : "+realContent2);
        if(Tool.checkFile(path)&&(realContent2!=null)&&(realContent2.equals(content2))){
            System.out.println("测试用例 2 执行成功，测试通过");
        }else{
            System.out.println("测试用例 2 执行失败，测试不通过");
        }
        System.out.println("测试创建文件API "+APIName+"结束.........");
    }
    ...
    public static void testCreateFile1(String path) {
        ...
        System.out.println("测试准备 2:检查用户设置的文件夹目录是否存在");
        boolean isExist = Tool.checkDir(path);
        if(isExist){
            System.out.println("该文件夹已经存在，请选择其他文件夹");
            return;
        }
        System.out.println("测试案例1 ：文件不存在，且overwrite 为false");
        ...
        try {
            ...
            System.out.println("创建文件 出现异常，请检查");
            e.printStackTrace();
        }
        System.out.println("检查测试案例执行结果");
        //检查测试是否通过
        ...
        if(Tool.checkFile(testfile1)&&(realContent!=null)&&(realContent.equals(content))){
            ...
            System.out.println("测试用例1 执行失败，测试不通过");
        }

        System.out.println("===================>>>>>>>>>>>>>==============================");
        System.out.println("测试案例2 ：文件不存在，且overwrite 为true");
        ...
        try {
            ...
            System.out.println("创建文件时 出现异常，请检查");
            e.printStackTrace();
        }
        System.out.println("检查测试案例执行结果");
        //检查测试是否通过
        ...
        if(Tool.checkFile(testfile2)&&(realContent2!=null)&&(realContent2.equals(content))){
            System.out.println("测试用例2  执行成功，测试通过");
            System.out.println("文件内容为: "+realContent2);
        }else{
            System.out.println("测试用例2 执行失败，测试不通过");
        }
        System.out.println("===================>>>>>>>>>>>>>==============================");
        System.out.println("测试案例3 ：文件存在，且overwrite 为true");
        boolean overwrite3 = true;
        String content2 = "World";
        Path filepath3 = new Path(testfile1);
        if(!Tool.checkFile(testfile1)){
            System.out.println("文件不存在，不满足测试条件,请检查测试代码");
        }
        try {
            ...
            System.out.println("重写文件时出现异常，请检查");
            e.printStackTrace();
        }
        System.out.println("检查测试案例执行结果");
        //检查测试是否通过
        ...
        if((realContent3!=null)&&(realContent3.equals(content2))){
            System.out.println("测试用例3  执行成功，测试通过");
            System.out.println("文件内容为: "+realContent3);
        }else{
            System.out.println("测试用例3 执行失败，测试不通过");
        }
        System.out.println("===================>>>>>>>>>>>>>==============================");
        System.out.println("测试案例4 ：文件存在，且overwrite 为false,将抛出异常");
        ...
        try {
            ...
            System.out.println("重写文件时出现异常，异常为正常显示");
            System.out.println("测试用例4 执行成功");
            e.printStackTrace();
            return;
        }
        System.out.println("测试用例4 执行失败");
        System.out.println("测试创建文件"+APIName+"结束......");
    }
    ...
    public static void testCreateFileWithProgress(String path) {
        ...
        System.out.println("测试创建文件 API:"+APIName+" 开始......");
        String content = "Hello";
        String testfile1 = path+"/test1.txt";
        String testfile2 = path+"/test2.txt";
        System.out.println("测试准备 1:获取DFS对象");
        ...
        System.out.println("测试准备 3:获得Progressable 对象");
        Progressable progressable = Tool.getProgressable();
        if(progressable == null){
            System.out.println("获取progreesable失败，请检查");
            return;
        }

        System.out.println("测试案例 1：该文件不存在，且创建文件时不写入数据，则无进度条显示，请注意进度条");
        Path filepath1 = new Path(testfile1);
        try {
        ...
        System.out.println("===================>>>>>>>>>>>>>==============================");
        System.out.println("测试案例 2：该文件不存在，且创建文件时写入数据，则进度条显示，请注意进度条");
        Path filepath2 = new Path(testfile2);
        try {
            ...
            System.out.println("创建文件时出现异常，请检查");
            e.printStackTrace();
        }
        System.out.println("检查测试案例执行结果");
        //检查测试是否通过
        ...
        System.out.println("===================>>>>>>>>>>>>>==============================");
        System.out.println("测试案例 3：该文件存在，且重写文件时不写入数据，则无进度条显示，请注意进度条");
        String content2 = "World";
        Path filepath3 = new Path(testfile1);
        if(!Tool.checkFile(testfile1)){
            System.out.println("文件不存在，不满足测试条件,请检查测试代码");
        ...
        System.out.println("===================>>>>>>>>>>>>>==============================");
        System.out.println("测试案例 4：该文件存在，且重写文件时写入数据，则进度条显示，请注意进度条");
        Path filepath4= new Path(testfile2);
        if(!Tool.checkFile(testfile2)){
            System.out.println("文件不存在，不满足测试条件,请检查测试代码");
        }
        ...
        System.out.println("文件内容为: "+realContent4);
        if((realContent4!=null)&&(realContent4.equals(""))){
            System.out.println("测试用例4  执行成功，测试通过");
        }else{
            System.out.println("测试用例4 执行失败，测试不通过");
        }

        System.out.println("测试创建文件 API:"+APIName+" 结束......");
    }
    ...
    public static void testCreateFileReplic(String path) {
        ...
        System.out.println("测试案例1 ：文件不存在，设置的副本数为4");
        Path filepath1 = new Path(testfile1);
        try {
            ...
            System.out.println("创建文件出现异常，请检查");
            e.printStackTrace();
        }
        System.out.println("检查测试案例执行结果");
        //检查测试是否通过
        ...
        System.out.println("文件内容为 : "+realContent);
        System.out.println("副本数 : "+realReplication);
        ...
        System.out.println("===================>>>>>>>>>>>>>==============================");
        System.out.println("测试案例2 ：文件存在，则重写该文件");
        String content2 = "World";
        boolean isFileExist = Tool.checkFile(testfile1);
        if(!isFileExist){
            System.out.println("该文件不存在，测试条件不满足，请检查测试代码");
            return;
        }
        try {
            FSDataOutputStream outputStream =  dfs.create(filepath1, repliaction);
        ...
        System.out.println("文件内容为: "+realContent2);
        System.out.println("副本数 : "+realReplication2);
        if(Tool.checkFile(testfile1)&&(realContent2!=null)&&(realContent2.equals(content2))&&(realReplication2==4)){
            System.out.println("测试用例2  执行成功，测试通过");
        }else{
            System.out.println("测试用例2 执行失败，测试不通过");
        }
        System.out.println("测试创建文件API:create(Path f,Short repliaction) 结束......");
    }
    ...
    public static void testCreatFileWithRP(String path) {
        ...
        System.out.println("测试创建文件API :"+APIName+"开始......");
        System.out.println("请注意执行进度条，进度条为... ");
        short repliaction = 4;
        String content = "Hello";
        String testfile1 = path+"/test1.txt";
        System.out.println("测试准备 1:获取DFS对象");
    ...
    public static void testCreateWithBlock(String path){
        ...
        if(Tool.checkFile(testfile1)&&(realContent!=null)&&(realContent.equals(content))&&(rep1 == replication)&&(bs1 == blockSize)){
            System.out.println("测试用例1 执行成功，测试通过");
            System.out.println("文件内容为 : "+realContent);
            System.out.println("副本数为: "+rep1);
            System.out.println("blockSize: "+bs1);
        }else{
            System.out.println("测试用例1 执行失败，测试不通过");
        }
        ...
        if(Tool.checkFile(testfile2)&&(realContent2!=null)&&(realContent2.equals(content))&&(rep2 == replication)&&(bs2 == blockSize)){
            System.out.println("测试用例2  执行成功，测试通过");
            System.out.println("文件内容为: "+realContent2);
            System.out.println("副本数为: "+rep2);
            System.out.println("blockSize: "+bs2);
        }else{
            System.out.println("测试用例2 执行失败，测试不通过");
        }
        System.out.println("===================>>>>>>>>>>>>>==============================");
        ...
        if((realContent2!=null)&&(realContent3.equals(content2))&&(rep3 == replication)&&(bs3 == blockSize)){
            System.out.println("测试用例3  执行成功，测试通过");
            System.out.println("文件内容为: "+realContent3);
            System.out.println("副本数为: "+rep3);
            System.out.println("blockSize: "+bs3);
        }else{
            System.out.println("测试用例3 执行失败，测试不通过");
        }
        System.out.println("===================>>>>>>>>>>>>>==============================");
    ...
    public static void testCreateWithB(String path){
        ...
        System.out.println("测试创建文件"+APIName+"开始......");
        String content = "Hello";
        String testfile1 = path+"/test1.txt";
        String testfile2 = path+"/test2.txt";
        System.out.println("测试准备 1:获取DFS对象");
    ...
    public static void testCreateFileWithPP(String path){
        ...
        System.out.println("测试API："+APIName+"开始.......");
        int bufferSize = 1024;
        short replication = 3;
        long blockSize = 1048576;
        ...
        DistributedFileSystem dfs = Tool.getDistributedFileSystem();
        Progressable progressable = Tool.getProgressable();
        System.out.println("测试准备：获取DFS对象");
        if(dfs == null){
            System.out.println("获取DFS对象失败，请检查");
            return;
        }
        System.out.println("测试案例1：文件不存在，API将创建该文件");
        boolean isFileExist = Tool.checkFile(path);
        if(isFileExist){
            System.out.println("文件已存在，请选择一个将新建的文件目录");
            return;
        }
        ...
        try{
            ...
            e.printStackTrace();
            System.out.println("文件创建失败，请检查");
        }

        //检查文件
        Tool.checkFileIsRight(isFileExist,path,content);

        System.out.println("测试案例2：文件已存在，API将重写该文件");
        String content2= "World";
    ...
    public static void testCreateFileWithOutput(String path){
        ...
        System.out.println("测试 "+apiName+" 开始......");
        short replication = 3;
        int bufferSize = 1024;
        long blockSize = 1048576;
        Path f = new Path(path);
        ...
        System.out.println("测试 "+apiName+" 结束......");
    }
    ...
    public static void testCreatNewFile(String path){
        ...
        System.out.println("测试API: "+apiName+"开始......");
        System.out.println("测试准备1：获取DFS对象");
        DistributedFileSystem dfs = Tool.getDistributedFileSystem();
        if(dfs == null){
            System.out.println("获取DFS对象失败，请检查");
            return;
        ...
        System.out.println("测试用例1: 文件不存在，返回为true");
        System.out.println("步骤1：检查用户输入的文件是否存在");
        boolean isFileExist = Tool.checkFile(path);
        if(isFileExist){
            System.out.println("该文件已存在，请重新选择一个不存在的文件目录");
            return;
        }
        ...
        try{
                ...
                System.out.println("创建文件失败，请检查");
            }
        if(result1){
            System.out.println("测试用例1: 测试通过");
        }else{
            System.out.println("测试用例1: 测试失败");
        }

        System.out.println("测试用例2: 文件存在，返回为false");
        ...
        if(!result2){
            System.out.println("测试用例2: 测试通过");
        }else{
            System.out.println("测试用例2: 测试失败");
        }
    }
    ...
    public static void testIsFile(String path){
        ...
        System.out.println("测试 "+apiName+"开始......");
        System.out.println("测试准备1：创建文件夹与文件");
        String DirPath = path;
        ...
        if(!result){
            System.out.println("创建文件夹与创建文件失败，请检查");
            return;
        }
        System.out.println("测试准备2：获取DFS对象");
        DistributedFileSystem dfs = Tool.getDistributedFileSystem();
        if(dfs ==null){
            System.out.println("获取DFS对象失败，请检查");
            return;
        ...
        System.out.println("测试案例1：f 为文件夹目录path");
        ...
        try{
            ...
            e.printStackTrace();
            System.out.println("检查文件失败，请检查......");
        }

        if(!result1){
            System.out.println("测试案例1：f 为文件夹目录 测试通过.........");
        }else{
            System.out.println("测试案例1：f 为文件夹目录 测试不通过.........");
        }


        System.out.println("测试案例2：f 为文件目录path");
        ...
        if(result2){
            System.out.println("测试案例2：f 为文件目录 测试通过.........");
        }else{
            System.out.println("测试案例2：f 为文件目录 测试不通过.........");
        }

        System.out.println("测试案例3：f 为不存在文件目录path");
        ...
        try{
            ...
            e.printStackTrace();
            System.out.println("检查文件是否存在失败，请检查......");
        }

        if(result3){
            System.out.println("测试案例3：f 为不存在文件目录 测试不通过.........");
        }else{
            System.out.println("测试案例3：f 为不存在文件目录 测试通过.........");
        }
    }
    ...
    public static void testOpenFile(String path){
        ...
        System.out.println("测试API: "+apiName+" 开始......");
        System.out.println("测试准备1：创建测试文件");
        ...
        if(content.equals(expect)){
            System.out.println("该用例测试通过...............");
        }else{
            System.out.println("该用例测试不通过...............");
        }
        System.out.println("测试API: "+apiName+" 结束......");
    }
 ...
 */
  public static void testAppend(String path)  {
      ...
      if(dfs==null){
          ...
          try{
              ...
              e.printStackTrace();
              System.out.println("append 文件失败，请检查......");
          }
   ...
   //API说明:追加文件时，以buffSize为限制，
    ...
    public static void testlistFile(String path){
       ...
       try {
           System.out.println("测试用例1：f 为文件夹，recursive 为false........");
           ...
           System.out.println("测试用例2：f 为文件夹，recursive 为true........");
           ...
           System.out.println("测试用例3：f 为文件，recursive 为false........");
           ...
           System.out.println("测试用例4：f 为文件，recursive 为true........");
           ...
           e.printStackTrace();
           System.out.println("调用该API 出现异常，请检查测试代码");
           return;
       }

        System.out.println("测试结果汇总如下:");
        if(result1==1){
            System.out.println("测试用例1：f 为文件夹，recursive 为false====通过 ");
        }else{
            System.out.println("测试用例1：f 为文件夹，recursive 为false====失败");
            System.out.println("实际结果为 "+result1);
        }

        if(result2==2){
            System.out.println("测试用例2：f 为文件夹，recursive 为true====通过 ");
        }else{
            System.out.println("测试用例2：f 为文件夹，recursive 为true====失败");
            System.out.println("实际结果为 "+result2);
        }

        if(result3==1){
            System.out.println("测试用例3：f 为文件，recursive 为false====通过 ");
        }else{
            System.out.println("测试用例3：f 为文件，recursive 为false====失败");
            System.out.println("实际结果为 "+result3);
        }

        if(result4==1){
            System.out.println("测试用例4：f 为文件，recursive 为true====通过 ");
        }else{
            System.out.println("测试用例4：f 为文件，recursive 为true====失败");
            System.out.println("实际结果为 "+result4);
        }
    ...
    //2.f 为文件
     public static void testlistLocatedStatus(String path){
         ...
         if(Tool.checkDir(path)){
             ...
             System.out.println("程序创建文件夹失败，请检查.......");
             return;
         }
       ...
       try{
           ...
           while(dir.hasNext()){
               ...
               System.out.println("文件夹名称: "+pathName);
           ...
           e.printStackTrace();
           System.out.println("获取信息失败，请检查");
           return;
       }

         System.out.println("测试案例1：参数为文件夹目录，获得结果为文件夹下文件信息");
         if(checkDir1&&checkDir2){
             System.out.println("文件信息显示正确，测试案例1 测试成功");
         }else{
             System.out.println("文件信息显示错误，测试案例1 测试失败");
         }
         System.out.println("测试案例2：参数为文件目录，获得结果为文件信息");
         if(checkFil){
             System.out.println("文件信息显示正确，测试案例2 测试成功");
         }else{
             System.out.println("文件信息显示错误，测试案例2 测试失败");
         }
     }
    ...
    public static void testListStatus(String path){
        ...
        try{
                ...
                if(f.length==0){
                    ...
                    System.out.println("该用例测试成功......");
                    System.out.println("该文件信息: "+f[0].toString()) ;
                }
            }catch(Exception e ){
                e.printStackTrace();
    ...
    public static void testListStatusWithFS(String path) {
        ...
        if (!precondition) {
            System.out.println("创建文件夹与文件失败，请检查......");
            return;
        }
        file1 = path + file1;
        file2 = path + file2;
        ...
        if (f.length == 2) {
            System.out.println("测试用例测试通过.........");
            System.out.println("第一个文件信息如下:  " + f[0].toString());
            System.out.println("第二个文件信息如下:  " + f[1].toString());
        } else {
            System.out.println("测试用例测试失败.........");
        }
        System.out.println("测试API: " + apiName + "开始......");
    }
  ...
  //返回值说明：a list of statuses for the files under the given paths after applying the filter
   ...
   public static void testListStatusWithFSF(String path) {
         ...
         System.out.println("测试结果如下...... ");
         if (f1.length == 2) {
             System.out.println("测试用例1： pathFilter 为 true===>测试通过");
         } else {
             System.out.println("测试用例1： pathFilter 为 true===>测试不通过");
         }

         if (f2.length == 0) {
             System.out.println("测试用例2： pathFilter 为 false===>测试通过");
         } else {
             System.out.println("测试用例2： pathFilter 为 false===>测试不通过");
         }
    ...
    public static void testIsSafeMode(){
        ...
        try{
            ...
            e.printStackTrace();
            System.out.println("获取安全模式失败，请检查");
        }
        System.out.println("测试结果如下：");
        if(result){
            System.out.println("测试用例失败，节点处于安全模式中");
        }else{
            System.out.println("测试用例成功，节点不处于安全模式中");
        }
        System.out.println("测试API: " + apiName + "结束......");
    }
   ...
   public static void testMoveLocalFile(String path){
       ...
       System.out.println("测试API: " + apiName + "开始......");
       System.out.println("测试步骤1：在HDFS上创建文件");
       boolean isSuccess = Tool.createFile(path);
       if(!isSuccess){
           System.out.println("在HDFS上创建文件失败，请检查");
           return;
       }
       String fileInLocal = "/home/bigdata/moveToLocalFile.txt";
       System.out.println("测试步骤2：移动文件到本地");
       DistributedFileSystem dfs = Tool.getDistributedFileSystem();
       if (dfs == null) {
           System.out.println("获取dfs失败，请检查");
           return;
       ...
       try{
           ...
           e.printStackTrace();
           System.out.println("API调用失败，请检查");
           return;
       }
       System.out.println("测试步骤3：检查移动后本地文件");
       String result = Tool.readLocalFile(fileInLocal);
       if(result.equals("helloWorld")) {
           System.out.println("用例测试通过........");
       }else{
           System.out.println("用例测试失败........");
           if(result==null){
               System.out.println("读取本地文件失败");
           }else{
               System.out.println("读取本地文件内容为"+result);
           }
       }
    ...
    public static void testCompleteLocalOutput(String path){
        ...
        System.out.println("测试API: " + apiName + "开始......");
        System.out.println("测试步骤1：在linux上创建文件,目录为/home/bigdata");
        String fileName = new Path(path).getName();
        boolean isSuccess = Tool.createLocalFile("bigdata",fileName);
        if(!isSuccess){
            System.out.println("创建本地文件失败，请检查目录及其权限是否正确");
            return;
        }
        System.out.println("测试步骤2：在HDFS上创建文件,文件目录即为控制台输入的目录");
        boolean isRight = Tool.createFile(path);
        if(!isRight){
            System.out.println("创建文件失败，请检查目录及其权限是否正确");
            return;
        }

        System.out.println("测试步骤3：复制本地文件内容到HDFS文件上");
        DistributedFileSystem dfs = Tool.getDistributedFileSystem();
        if (dfs == null) {
            System.out.println("获取dfs失败，请检查");
            return;
        ...
        System.out.println("测试步骤3：检查复制后HDFS上文件");
    ...
    public static void testDelete(String path){
        ...
        String file1 = "/test1.txt";
        String file2 = "/test2.txt";
        System.out.println("测试用例1：文件夹下无文件，递归删除为false，文件夹被成功删除");
        ...
        if(result1){
            System.out.println("测试用例1：执行失败");
        }else{
            System.out.println("测试用例1：执行成功");
        }

        System.out.println("测试用例2：文件夹下有文件，递归删除为false，删除出现异常");

        System.out.println("测试步骤1：创建文件和文件夹");
        boolean create = Tool.createDirAndFile(path,file1,file2);
        if(!create){
            System.out.println("创建文件夹和文件失败，请检查");
            return;
        }
        Path path1 = new Path(path);
        ...
        if(Tool.checkDir(path)&&Tool.checkFile(path+file2)&&(Tool.checkFile(path+file1))){
            System.out.println("测试用例2：递归删除为false====>通过");
        }else{
            System.out.println("测试用例2：递归删除为false====>失败");
        }

        System.out.println("测试用例3：文件夹下有文件，递归删除为true，文件夹与文件都将删除成功");
        ...
        if(!Tool.checkFile(newPath+file2)&&(!Tool.checkFile(newPath+file1))&&(!Tool.checkDir(newPath))){
            System.out.println("测试用例3：递归删除为true====>通过");
        }else{
            System.out.println("测试用例3：递归删除为true====>失败");
        }
    ...
    public static void testResolvePath(String path){
        ...
        System.out.println("测试步骤2：获取DistributedFileSystem对象");
        DistributedFileSystem dfs = Tool.getDistributedFileSystem();
        if(dfs==null){
            System.out.println("获取dfs失败，请检查");
            return;
        }
        System.out.println("测试步骤3：解析Path对象");
        System.out.println("测试用例1：path为已经存在的路径，应解析为正确路径");
        Path Directory = new Path(path);
        Path result = null;
        try{
            result = dfs.resolvePath(Directory);
        }catch(Exception e){
            System.out.println("解析路径失败，请检查");
        }
        System.out.println("测试结果如下:");
        if(result==null){
            System.out.println("测试用例1：解析失败，该用例测试失败，请检查");
        }else{
            System.out.println("测试用例1：解析成功，该用例测试成功");
            System.out.println("解析如下:"+result.toString());
        }

        Path wrong = new Path(Directory+"/aa");
        Path result1 = null;
        System.out.println("测试用例2：path为不存在的路径，应抛出异常");
        try{
            result1 = dfs.resolvePath(wrong);
        }catch (Exception e){
            System.out.println("测试用例2 执行成功，抛出异常");
            e.printStackTrace();
        }
        if(result1==null){
            System.out.println("测试用例2：执行成功");
        }
        System.out.println("测试API: " + apiName + "结束......");
    }
    ...
    public static void testMakeQualified(String path){
        ...
        System.out.println("测试准备：创建文件和文件夹");
        boolean create = Tool.createDirAndFile(path,file1,file2);
        if(!create){
            System.out.println("创建文件夹和文件失败，请检查");
            return;
        ...
        System.out.println("测试准备：获取DistributedFileSystem对象");
        DistributedFileSystem dfs = Tool.getDistributedFileSystem();
        if(dfs==null){
            System.out.println("获取dfs失败，请检查");
            return;
        ...
        System.out.println("测试用例1：参数为正确的Path,应返回正确的path");
        Path result1 = null;
        try{
        ...
        if(result1==null){
            System.out.println("测试用例1失败，请检查");
        }else{
            System.out.println("测试用例1成功,Path 信息如下：");
            System.out.println(result1.toString());
        }
        System.out.println("测试用例2：参数为错误的Path,解析为HDFS上路径");
        Path result2 = null;
        try{
            result2 = dfs.makeQualified(path2);
        }catch (Exception e){
            System.out.println("测试用例2失败！,它将抛出异常");
            e.printStackTrace();
        }
        if(result2==null){
            System.out.println("测试用例2失败");
        }else{
            System.out.println("测试用例2成功,Path 信息如下：");
    ...
    public static void testGlobStatus(String path){
        ...
        System.out.println("测试用例:传入的正则为*,返回该文件夹下文件信息");
        ...
        try{
            ...
            e.printStackTrace();
            System.out.println("测试用例失败，请检查");

        }
        if(result == null){
            System.out.println("测试用例失败，请检查");
        }else{
            System.out.println("测试用例成功,信息如下：");
            System.out.println("文件信息汇总如下：");
            int i  = result.length;
            System.out.println("共计："+i+" 个信息");
            for(int j = 0; j< i; j++){
    ...
    public static void testGlobalStatusWithFilter(String path){
        ...
        System.out.println("测试用例1:pathPattern匹配文件夹下的文件，pathFile 为true,返回值为 FileStatus数组");
        ...
        try{
            ...
            e.printStackTrace();
            System.out.println("测试用例1异常，请检查");
        }
        if(result1 == null){
            System.out.println("测试用例1:失败，请检查");
        }else{
            System.out.println("测试用例1:成功,信息如下：");
            System.out.println("文件信息汇总如下：");
        ...
        System.out.println("测试用例2:pathPattern不能匹配文件夹下的文件，pathFile 为false,返回值为null");
        ...
        try{
            ...
            e.printStackTrace();
            System.out.println("测试用例2异常，请检查");

        }
        if(result2 == null){
            System.out.println("测试用例2:成功，请检查");
        }else{
            System.out.println("测试用例2:失败,请检查");
        }


        System.out.println("测试用例3:pathPattern能匹配文件夹下的文件，pathFile 为false,返回值为空FileStatus数组");
        ...
        try{
            ...
            e.printStackTrace();
            System.out.println("测试用例3异常，请检查");

        }
        if(result3 == null){
            System.out.println("测试用例3:失败，请检查");
        }else{
            System.out.println("测试用例3:成功,请检查");
        }
        System.out.println("测试API: " + apiName + "结束......");
    }
    ...
    public static void testAllowSnapshot(String path){
        ...
        System.out.println("测试结果检查：");
        String snapshot = path+"/.snapshot";

        if(Tool.checkDir(snapshot)){
            System.out.println("快照文件夹创建成功，用例测试通过！");
        }else{
            System.out.println("快照文件夹创建失败，用例测试不通过！");
        }
    }
    ...
    public static void testCreateSnapshot(String path){
        ...
        try{
            System.out.println("测试步骤1：开启snapshot");
            dfs.allowSnapshot(Directory);
            System.out.println("测试步骤2：创建snapshot文件");
        ...
        if(Tool.checkDir(snapshot)){
            System.out.println("快照记录文件夹创建成功，用例测试通过！");
        }else{
            System.out.println("快照记录文件夹创建失败，用例测试不通过！");
        }
    ...
    public static void testRenameSnapshot(String path){
        ...
        try{
            ...
            System.out.println("测试步骤2：创建snapshot文件");
            dfs.createSnapshot(Directory,name);
            System.out.println("测试步骤3：重命名snapshot文件");
        ...
        if(Tool.checkDir(snapshot)){
            System.out.println("快照记录文件重命名成功，用例测试通过！");
        }else{
            System.out.println("快照记录文件重命名失败，用例测试不通过！");
        }
    ...
    public static void testDeleteSnapshot(String path){
        ...
        try{
            ...
            System.out.println("测试步骤2：创建snapshot文件");
            dfs.createSnapshot(Directory,name);
            System.out.println("测试步骤3：删除snapshot文件");
        ...
        System.out.println("测试结果检查：");
        if(Tool.checkDir(snapshot)){
            System.out.println("删除快照失败，用例测试不通过！");
        }else{
            System.out.println("删除快照成功，用例测试通过！");
        }
        System.out.println("测试API: " + apiName + "结束......");
    }
    ...
    public static void testDisallowSnapshot(String path){
        ...
        try{
            System.out.println("测试步骤1：开启snapshot");
            dfs.allowSnapshot(Directory);
            System.out.println("测试步骤2：关闭snapshot");
        ...
        System.out.println("测试结果检查：");
        if(Tool.checkDir(snapshot)){
            System.out.println("关闭快照失败，用例测试不通过！");
        }else{
            System.out.println("关闭快照成功，用例测试通过！");
        }
        System.out.println("测试API: " + apiName + "结束......");
    }
    ...
    public static void testAddCachePool(String poolname ){
        ...
        System.out.println("测试准备：检查缓存池是否存在");
        boolean result  = Tool.checkCachePool( poolname);
        if(result){
            System.out.println("该缓存池已经存在，请重新传入缓存池名称");
            return;
        }
        ...
        if(lastResult){
            System.out.println("该缓存池添加成功，用例执行成功");
        }else{
            System.out.println("该缓存池添加失败，用例执行失败");
        }
        System.out.println("测试API: " + apiName + "结束......");
    }
    ...
    public static void testRemoveCachePool(String poolName){
        ...
        System.out.println("测试步骤1：添加缓存池，名称为 "+poolName);
        CachePoolInfo cachePoolInfo = new CachePoolInfo(poolName);
        try{
            dfs.addCachePool(cachePoolInfo);
        }catch(Exception e){
        ...
        System.out.println("测试步骤2：移除缓存池，名称为 "+poolName);
        try{
            dfs.removeCachePool(poolName);
        }catch(Exception e){
            System.out.println("移除缓存池失败，请检查");
            e.printStackTrace();
            return;
        }
        //如何检查
        boolean lastResult = Tool.checkCachePool(poolName);
        if(!lastResult){
            System.out.println("该缓存池删除成功，用例执行成功");
        }else{
            System.out.println("该缓存池删除失败，用例执行失败");
        }
    ...
    public static void testListCachePools(String poolName){
        ...
        if(cachePoolEntryRemoteIterator == null){
            System.out.println("该用例执行失败，请检查");
            return;}
        ...
        if(checkPoolName1&&checkPoolName2){
            System.out.println("该用例执行成功.......PASS");
        }else{
            System.out.println("该用例执行失败，请检查");
        }
        System.out.println("测试API: " + APIName + "结束......");
    ...
    public static void testModifyCachePool(String poolName){
        ...
        System.out.println("测试步骤2：修改缓存池owner属性为Jack，名称为 "+poolName);
        String ownerName = "Jack";
        cachePoolInfo.setOwnerName(ownerName);
        try{
            dfs.modifyCachePool(cachePoolInfo);
        }catch(Exception e){
            System.out.println("修改缓存池失败，请检查");
            e.printStackTrace();
            return;}

        System.out.println("测试步骤3：检查缓存池owner属性为Jack，名称为 "+poolName);
        boolean lastResult = false;
        RemoteIterator<CachePoolEntry> cachePoolEntryIterator = null;
        try{
            System.out.println("测试步骤3-1：获取缓存池列表");
        ...
        try {
            ...
            return;}
        if(lastResult){
            System.out.println("该用例执行成功");
        }else{
            System.out.println("该用例执行失败");
        }
        System.out.println("测试API: " + APIName + "结束......");
    }
    ...
    public static void testAddCacheDirective(String poolName,String fileName){
        ...
        System.out.println("测试准备：检查文件是否存在");
        boolean isFileExist = Tool.checkFile(fileName);
        if(isFileExist){
            System.out.println("文件已经存在，请重新选择文件");
            return;}
        ...
        System.out.println("测试步骤2：添加文件，名称为 "+fileName);
        ...
        System.out.println("测试步骤3：添加缓存文件");
        Path filePath = new Path(fileName);
        String cacheFileName = filePath.getName();
        System.out.println("cache file name is "+cacheFileName);
        ...
        try{
            ...
            System.out.println("添加缓存文件失败，请检查");
            e.printStackTrace();
            return;
        }
        ...
        try {
            ...
            while (remoteIterator.hasNext()) {
                ...
                System.out.println(realCoachFile);
                if(realCoachFile.equals(cacheFileName)){
                    lastResult = true;
                    System.out.println("Find the file name ,break!!");
                    break;
                }
            }
        }catch(Exception e){
    ...
    public static void testAddCacheDirWithFlage(String poolName,String fileName){
        ...
        System.out.println("添加缓存文件在缓存中的名称: "+realName);
        CacheDirectiveInfo info = new CacheDirectiveInfo.Builder().
                setExpiration(CacheDirectiveInfo.Expiration.newAbsolute(10000)).setPath(filePath).
                setPool(poolName).setReplication((short) 1).build();
        ...
        try {
            ...
            while(remoteIterator.hasNext()) {
                ...
                System.out.println("缓存中文件实际名称: "+coachName);
                System.out.println("=============>>>===================");
    ...
    public static void testListCacheDirectives(String poolName,String fileName){
        ...
        boolean isFileExist = Tool.checkFile(fileName);
        if(isFileExist){
            System.out.println("文件"+fileName+"已经存在，请重新选择文件");
            return;}

        boolean isFileExist2 = Tool.checkFile(fileName2);
        if(isFileExist2){
            System.out.println("文件"+fileName2+"已经存在，请重新选择文件");
            return;}
        ...
        System.out.println("测试步骤3：添加文件，名称为 "+fileName2);
...
//        System.out.println("TestCase1：传入带参");
...
//        }
//        if( Iterator1== null){
//            System.out.println("获取RemoteIterator为空，请检查");
//            return;
//        }
//
...
//                System.out.println("PATH name"+RealfilePath);
...
//            }
//        }catch(Exception e){
//            System.out.println("RemoteIterator迭代失败，请检查");
//            e.printStackTrace();
//            return;
//        }
//        if(lastResult1){
//            System.out.println("TestCase1：测试用例通过");
//        }else{
//            System.out.println("TestCase1：测试用例失败");
//        }



        System.out.println("TestCase：不传入带参");
...
//        }
        ...
        if(lastResult2){
            System.out.println("TestCase2：测试用例通过");
        }else{
            System.out.println("TestCase2：测试用例失败");
        }
    }
    ...
    public static void testModifyCacheDir(String poolName,String fileName){
       ...
       info = new CacheDirectiveInfo.Builder().
        ...
        System.out.println("测试步骤4：修改缓存文件");
        try {
        ...
        if(Iterator == null){
            System.out.println("获取RemoteIterator失败，值为null,请检查");
            return;
        }
        Short repliaction = 0;
        try {
            while (Iterator.hasNext()) {
               ...
               // long id = temp.getId();
                ...
                System.out.println("缓存文件名："+coachName);
                System.out.println("缓存文件副本数: "+repliaction);
                if(coachName.equals(coachFileName)){
                    System.out.println("找到该文件，修改该文件");
                   // dfs.addCacheDirective(info);
        ...
        if(isRight){
            System.out.println("修改成功，副本数修改正确，测试用例通过");
        }else{
            System.out.println("修改失败，预期修改副本数为: "+3+"实际副本数为: "+repliaction);
        }
    ...
    public static void testRemoveCachDir(String poolName,String fileName){
        ...
        System.out.println("测试步骤4：删除缓存文件");
        Long id = 0L;
        try {
            System.out.println("获取缓存文件ID");
            ...
            while(It.hasNext()) {
                ...
                System.out.println("缓存池名称 " + temp.getPool());
                System.out.println("缓存文件id为 " + temp.getId());
                System.out.println("缓存文件名称 " + temp.getPath().getName());
                //dfs.removeCacheDirective(id);
                if (poolName.equals(temp.getPool()) && cacheFileName.equals(temp.getPath().getName())) {
                    id = temp.getId();
                    System.out.println("文件id 为"+id);
                    break;
                }
            }
            if(id!=0L){
                System.out.println("根据id删除文件！");
                dfs.removeCacheDirective(id);
            }else{
                System.out.println("没找到删除文件！");
            }
        }catch(Exception e){
            e.printStackTrace();
            return;
        ...
        boolean lastResult = false;
        try {
            System.out.println("测试步骤5：检查删除缓存文件");
    ...
    public static void testRemoveDefaultAcl(String DirPath){
        ...
        System.out.println("测试API: " + APIName + "开始......");
        System.out.println("测试准备1：获取DistributedFileSystem对象");
        DistributedFileSystem dfs = Tool.getDistributedFileSystem();
        if(dfs==null){
            System.out.println("获取dfs失败，请检查");
            return;}

        System.out.println("测试准备2：创建文件夹与文件");
        ...
        try{
            ...
            e.printStackTrace();
            System.out.println("测试执行时发生异常，请检查");
            return;
        }

        if(aclStatus == null){
            System.out.println("获取aclStatus 对象为空，请检查");
            return;
        }
        ...
        if(size == 0){
            System.out.println("the aclEntries size 为 0");
            System.out.println("移除默认ACL,测试用例执行成功");
            return;
        }else {
            for (int i = 0; i < aclEntries.size(); i++) {
                AclEntry aclEntry = aclEntries.get(i);
                aclEntryName = aclEntry.getName();
                System.out.println("aclEntry name is " + aclEntryName);
                permissionName = aclEntry.getPermission().name();
                System.out.println("permission name is : " + permissionName);
            ...
            if(!testResult){
                ...
                System.out.println("移除默认ACL,测试用例执行失败");
            }
    ...
    public static void testRemoveACL(String path){
        ...
        for(int i = 0;i <aclEntries.size();i++){
            AclEntry aclEntry = aclEntries.get(i);
            aclEntryName = aclEntry.getName();
            System.out.println("aclEntry name2 "+ aclEntryName);
            FsAction permission = aclEntry.getPermission();
            permissionName  = permission.name();
            System.out.println("permission name2: "+permissionName);
            AclEntryScope scope = aclEntry.getScope();
            scopeName = scope.name();
            System.out.println("scope name2: "+ scopeName);
        ...
        if(!testResult){
            System.out.println("删除成功,测试用例执行成功");
        }else{
            System.out.println("删除失败,测试用例执行失败");
        }
    ...
    public static void testRemoveAclEntries(String filePath){
        ...
        System.out.println("测试准备2：创建文件");
        boolean checkFile = Tool.checkFile(filePath);
        if(checkFile){
            System.out.println("文件已经存在，请选择其他文件名");
            return;}
        ...
        try{
           ...
           aclStatus = dfs.getAclStatus(path);
            ...
            e.printStackTrace();
            System.out.println("移除时发生异常，请检查");
            return;
        }
        ...
        for(int i = 0;i <aclEntries.size();i++){
            AclEntry aclEntry = aclEntries.get(i);
            aclEntryName = aclEntry.getName();
            System.out.println("aclEntry name1 "+ aclEntryName);
            FsAction permission = aclEntry.getPermission();
            permissionName  = permission.name();
            System.out.println("permission name1: "+permissionName);
            AclEntryScope scope = aclEntry.getScope();
            scopeName = scope.name();
            System.out.println("scope name1: "+ scopeName);
            AclEntryType type =  aclEntry.getType();
            typeName=type.name();
        ...
        if(!testResult){
            System.out.println("移除成功,测试用例执行成功");
        }else{
            System.out.println("移除失败,测试用例执行失败");
        }
    ...
    public static void testModifyAclEntries(String filePath){
        ...
        for(int i = 0;i <aclEntries.size();i++){
            AclEntry aclEntry = aclEntries.get(i);
            aclEntryName = aclEntry.getName();
            System.out.println("aclEntry name "+ aclEntryName);
            FsAction permission = aclEntry.getPermission();
            permissionName  = permission.name();
        ...
        if(testResult){
            System.out.println("修改成功,测试用例执行成功");
        }else{
            System.out.println("修改失败,测试用例执行失败");
        }
    ...
    public static void testIsDirectory(String path){
        ...
        if(Tool.checkFile(file)){
            System.out.println("该文件已经存在，请输入其他文件夹，程序将自动帮你创建");
            return;
        }else{
            boolean isSuccess = Tool.createFile(file);
            if(isSuccess){
                System.out.println("文件创建成功，测试准备完毕");
            }else{
                System.out.println("文件创建失败，请检查");
                return;
            }
        ...
        System.out.println("测试案例1：f 为文件夹，期望结果为true");
        Path Dir = new Path(path);
        ...
        try{
            ...
            System.out.println("判断文件夹出现异常，请检查!");
            e.printStackTrace();
        }
        if(result1){
            System.out.println("测试案例1 测试成功！");
        }else{
            System.out.println("测试案例1 测试失败！");
        }
        System.out.println("测试案例2：f 为文件，期望结果为false");
        if(!result2){
            System.out.println("测试案例2 测试成功！");
        }else{
            System.out.println("测试案例2 测试失败！");
        }
    }
}